...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <script type="text/html" id="currentTableBar">
            ...
            <a class="layui-btn layui-btn-xs data-count-detail" lay-event="view">中期检查</a>
        </script>
...
<script>
    layui.use(['form', 'table', 'excel'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/check/findAll.do',
            toolbar: '#toolbarDemo',
        ...
        form.on('submit(data-search-btn)', function (data) {
            ...
            table.reload('currentTableId', {
                ...
                ,url:'${pageContext.request.contextPath}/check/search.do'
                ,done: function () {
                    bindTableToolbarFunction();
                }
            }, 'data');
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'view') {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['50%', '40%'],
                    content: '${pageContext.request.contextPath}/check/viewByPid.do?pid='+data.paper.pid
                });
...
// ==================== 解决table.reload后toolbar失效问题 ====================
        ...
        function bindTableToolbarFunction() {
            ...
            $(".data-export").on("click", function () {
                ...
                // 从后端接口读取需要导出的数据
                $.ajax({
                    url:'${pageContext.request.contextPath}/check/export.do'
                    , dataType: 'json'
