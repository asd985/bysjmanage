...
<script>
    layui.use(['form'], function () {
        ...
        $(".data-confirmTrue").on("click", function () {
            $.get("${pageContext.request.contextPath}/report/confirmTrueByPid.do?pid="+${pid},function () {
                layer.msg("确认成功");
        ...
        $(".data-confirmFalse").on("click", function () {
            $.get("${pageContext.request.contextPath}/report/confirmFalseByPid.do?pid="+${pid},function () {
                layer.msg("驳回成功");
                window.parent.location.reload();
            });
            $(window).on("resize", function () {
