                            ...
                            <div class="layui-card">
                                ...
                                <div class="layui-card-body">
                                    <div class="layuimini-main layui-top-box">
                                        <div class="layui-row layui-col-space15">
                                            <div class="layui-row contnet-message-body">
                                                <div class="layui-col-xs12 layui-col-sm4 layui-col-md2 contnet-message-div "><strong>指导教师：</strong><span class="name">${user.name}</span></div>
                                                <div class="layui-col-xs12 layui-col-sm4 layui-col-md2 contnet-message-div "><strong>教师工号：</strong><span class="code">${user.username}</span></div>
                                                <div class="layui-col-xs12 layui-col-sm4 layui-col-md2 contnet-message-div "><strong>学院：</strong><span class="colloge">${user.college}</span></div>
                                                <div class="layui-col-xs12 layui-col-sm4 layui-col-md2 contnet-message-div "><strong>专业：</strong><span class="major">${user.major}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
