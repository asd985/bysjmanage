...
<div class="layui-form layuimini-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="teacherId"  disabled placeholder="请输入教师工号" value=<security:authentication property="principal.username" /> class="layui-input">
        </div>
    </div>
    </security:authorize>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="studentId" disabled placeholder="请输入学生学号" value=<security:authentication property="principal.username" /> class="layui-input">
        </div>
    </div>
    </security:authorize>
    <security:authorize access="hasRole('TEACHER')">
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                type:"POST",
                url:"${pageContext.request.contextPath}/paper/saveMine.do",
