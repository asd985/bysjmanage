...
<script>
    layui.use(['form', 'table'], function () {
        ...
        table.render({
            elem: '#currentTableId',
            url: '${pageContext.request.contextPath}/paper/findAll.do',
            toolbar: '#toolbarDemo',
        ...
        table.on('tool(currentTableFilter)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['50%', '80%'],
                    content: '${pageContext.request.contextPath}/paper/findByPid.do?pid='+data.pid
                });
        ...
        function bindTableToolbarFunction() {
            ...
            $(".data-add-btn").on("click", function () {
                ...
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['40%', '80%'],
                    content: '${pageContext.request.contextPath}/pages/paper/add.jsp',
                });
                $(window).on("resize", function () {
                    layer.full(index);
                });
