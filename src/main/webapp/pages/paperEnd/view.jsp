	...
	<script>
		layui.use(['upload', 'jquery'], function(){
			...
			var uploadInst = upload.render({
				elem: '#upload1' //绑定元素
				,url: '${pageContext.request.contextPath}/paperEnd/upload.do' //上传接口
				,accept: 'file' //普通文件
	...
	<div class="layui-form">
		...
		<div class="layui-form-item">
			...
			<c:if test="${paperEnd.status>0}">
				...
				<div class="layui-form-block">
					<a class="layui-btn layui-btn-primary" name="fileurl" href="${pageContext.request.contextPath}/${paperEnd.fileurl}">点击下载文件</a>
				</div>
			</c:if>
		</div>
		<div class="layui-form-item">
